  ...
  return (
    ...
    >
      ...
      <div 
        ...
        className="relative shrink-0 w-10 h-10 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex items-center justify-center overflow-hidden transition-all hover:scale-105 active:scale-95 group/heart"
      ...
      >
        ...
        <Heart 
          className={`absolute w-7 h-7 transition-all duration-300 ${
            isFavorite 
              ...
              : 'text-emerald-500/20 fill-emerald-500/10 scale-100 group-hover/heart:scale-110'
          }`}
          strokeWidth={1.5}
        />
        ...
        <span className={`relative z-10 font-black font-sans text-base transition-colors duration-300 ${
          isFavorite ? 'text-rose-500 dark:text-rose-400' : 'text-emerald-700 dark:text-emerald-400'
        }`}>
